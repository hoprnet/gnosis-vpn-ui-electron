...
export const Status = forwardRef<HTMLDivElement>((_, ref) => {
  ...
  return (
    <div
      ref={ref}
      className={`flex flex-row items-center bg-white rounded-3xl py-3 px-6 font-bold ${colors[status].text} mt-10 text-sm capitalize border-1 ${colors[status].border}`}
    >
      <span
